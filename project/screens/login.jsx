// LoginScreen — Splash + social login
function LoginScreen() {
  const nav = (window.useNav && window.useNav()) || { go: () => {} };
  const goHome = () => nav.go('home');
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius: '50%', background: 'rgba(255,255,255,0.08)', filter: 'blur(4px)',
      }} />
      <div style={{
        position: 'absolute', bottom: 220, left: -80, width: 220, height: 220,
        borderRadius: '50%', background: 'rgba(255,255,255,0.06)', filter: 'blur(4px)',
      }} />
      ...
      <div style={{
        ...
        <img src="assets/mascot-hero.png" alt="킹짱이" style={{
          width: 220, height: 'auto', objectFit: 'contain',
          filter: 'drop-shadow(0 14px 22px rgba(120,20,0,0.28))',
        }} />

        <div style={{
          marginTop: 18, whiteSpace: 'nowrap',
          fontFamily: '"Black Han Sans", "PyeongChang Peace", "Inter", sans-serif',
          fontWeight: 800, fontSize: 60, letterSpacing: -1, lineHeight: 1,
          textShadow: '0 4px 0 rgba(0,0,0,0.10), 0 8px 24px rgba(0,0,0,0.18)',
        ...
        <div style={{
          marginTop: 14, fontSize: 15, fontWeight: 500, whiteSpace: 'nowrap',
      ...
      <div style={{
        ...
        <button onClick={goHome} style={{
          ...
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <ellipse cx="10" cy="9" rx="9" ry="7.5" fill="#191600"/>
            <path d="M7 13.5L5.5 17l4-2.2" fill="#191600"/>
          </svg>
          카카오로 시작하기
        </button>
        ...
        <button onClick={goHome} style={{
          marginTop: 10,
          width: '100%', height: 54, borderRadius: 14, border: '1px solid rgba(255,255,255,0.10)',
        ...
        <button onClick={goHome} style={{
          ...
          background: 'rgba(255,137,4,0.12)', border: '1px solid rgba(255,137,4,0.35)',
          color: '#FFB261', fontSize: 15, fontWeight: 600,
          display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
          fontFamily: 'inherit', cursor: 'pointer',
        }}>
          <span style={{
            width: 18, height: 18, borderRadius: 5,
            background: '#FF8904', color: '#fff', fontSize: 11, fontWeight: 800,
        ...
        <div style={{
          ...
          가입 시 <span style={{ color: '#FFB261', textDecoration: 'underline' }}>이용약관</span> 및
          {' '}<span style={{ color: '#FFB261', textDecoration: 'underline' }}>개인정보처리방침</span>에 동의합니다.
        </div>
      </div>
    </div>
  );
